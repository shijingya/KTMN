...
class PATH:
    ...
    def init_path(self):
        ...
        self.DATA_ROOT = '/home/shenxiang/sda/Datasets/datasets'  # 3090服务器 VQA v2路径
        # self.DATA_ROOT = '/home/shenxiang/sda/Datasets'   # 3090服务器 clevr路径
        # self.DATA_ROOT = '/data/datasets'
        # self.DATA_ROOT = '/data1/datasets'
        # self.DATA_ROOT = '/home/features'

        self.DATA_PATH = {
            'vqa': self.DATA_ROOT + '/coco_extract',
        ...
        self.RAW_PATH = {
            'vqa': {
                'train': self.DATA_ROOT + '/vqa' + '/v2_OpenEnded_mscoco_train2014_questions.json',
                'train-anno': self.DATA_ROOT + '/vqa' +'/v2_mscoco_train2014_annotations.json',
                'val': self.DATA_ROOT + '/vqa' + '/v2_OpenEnded_mscoco_val2014_questions.json',
                'val-anno': self.DATA_ROOT + '/vqa' + '/v2_mscoco_val2014_annotations.json',
                'vg': self.DATA_ROOT + '/vqa' + '/VG_questions.json',
                'vg-anno': self.DATA_ROOT + '/vqa' + '/VG_annotations.json',
                'test': self.DATA_ROOT + '/vqa' + '/v2_OpenEnded_mscoco_test2015_questions.json',
            },
            'gqa': {
