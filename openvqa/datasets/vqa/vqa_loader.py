...
class DataSet(BaseDataSet):
    ...
    def load_img_feats(self, idx, iid):
        ...
        frcn_feat_x = frcn_feat['x'].transpose((1, 0))  # 21,2048
        frcn_feat_bbox = frcn_feat['bbox']
        frcn_feat_h = frcn_feat['image_h']
        frcn_feat_w = frcn_feat['image_w']

        frcn_feat_iter = self.proc_img_feat(  # 21,2048----->100,2048
            frcn_feat_x,  # 21,2048
            img_feat_pad_size=self.__C.FEAT_SIZE['vqa']['FRCN_FEAT_SIZE'][0]  # 100
        )
        '''
        ...
        bbox_feat_iter = self.proc_img_feat(  # 100,4
            frcn_feat['bbox'],
            img_feat_pad_size=self.__C.FEAT_SIZE['vqa']['BBOX_FEAT_SIZE'][0]
        )
        ...
        return frcn_feat_iter, grid_feat_iter, bbox_feat_iter, w_feat_iter, h_feat_iter
